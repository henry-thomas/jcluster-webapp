...
//                        if (target._jscLinkedInstance.targetElement.select) {
//                            target._jscLinkedInstance.targetElement.select();
//                        } else if (target._jscLinkedInstance.targetElement.setSelectionRange) {
//                            target._jscLinkedInstance.targetElement.setSelectionRange(0, this.input.value.length);
//                        }
