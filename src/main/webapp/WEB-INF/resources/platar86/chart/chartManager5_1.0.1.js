...
//
//
///* global am4charts, am4core, this, _, hh, mainUtils, smdui, sui, mu */
//
//(function (root) {
//    if (!root.cm) {
...
//                    } else {
//                        console.warn('Unknow Callback received!');
//                    }
//                }
//            },
//
...
//    };
//
//    SMDUIChart.prototype.toggleFullscreen = function (button) {
//        let onExitFullscreen = function () {
//            button.text = `<i class = "fas fa-expand"></i>`;
...
//            button.text = `<i class = "fas fa-compress"></i>`;
...
//                });
//
//                this.confCtrl.tool.saveSettingsTemplate = new SettingPanel(this.confCtrl.tool.tab, {
//                    title: 'saveSettings',
//                    toolTip: 'Saves this template. Will be available in the dropdown selection menu.',
//                    label: 'Save',
//                    type: 'button',
//                    onChange: function () {
//                        if (this.flags.uniqueSettingsActive === true) {
//                            cm.saveChartConf(this.name, this.conf, true);
//                            cm.saveChartConf(this.name, this.confDefCopy);
//                        } else {
//                            cm.saveChartConf(this.name, this.conf);
//                        }
//                    }.bind(this)
//                });
//            }.bind(this)
...
//            this.bottomContainer.classList.add('smdui-chart-charContainer');
