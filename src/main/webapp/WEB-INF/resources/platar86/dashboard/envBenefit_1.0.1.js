...
envB.dataChange = function () {
    try {
        ...
        if (dashMan.electricityTariff !== undefined) {
            document.getElementsByClassName('savingsDaily')[0].textContent = 'R' + ((envB.pvValues.sumData.dailyEnergyWh / 1000) * dashMan.electricityTariff).toFixed(1);
            document.getElementsByClassName('savingsMonthly')[0].textContent = 'R' + ((envB.pvValues.sumData.monthlyEnergyWh / 1000) * dashMan.electricityTariff).toFixed(1);
            document.getElementsByClassName('savingsYearly')[0].textContent = 'R' + ((envB.pvValues.sumData.yearlyEnergyWh / 1000) * dashMan.electricityTariff).toFixed(1);
            document.getElementsByClassName('savingsTotal')[0].textContent = 'R' + ((envB.pvValues.sumData.energyWh / 1000) * dashMan.electricityTariff).toFixed(1);
        }
        ;
