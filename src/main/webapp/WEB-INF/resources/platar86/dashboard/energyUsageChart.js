...
//            && energyUsage.powers.load.dataAvailable === true
//            && energyUsage.powers.gridExport.dataAvailable === true
//            && energyUsage.powers.storageDischarge.dataAvailable === true
            ) {
            ...
            case 'today':
                {
                    ...
                    energyUsage.pValues.load = energyUsage.powers.load.sumData.dailyEnergyWh;
                    energyUsage.pValues.grid = energyUsage.powers.gridImport.sumData.dailyEnergyWh;
                    energyUsage.pValues.stDisch = energyUsage.powers.storageDischarge.sumData.dailyEnergyWh;
                }
                break;
            case 'monthly':
                {
                    energyUsage.pValues.pv = energyUsage.powers.pv.sumData.monthlyEnergyWh;
                    energyUsage.pValues.load = energyUsage.powers.load.sumData.monthlyEnergyWh;
                    energyUsage.pValues.grid = energyUsage.powers.gridImport.sumData.monthlyEnergyWh;
                    energyUsage.pValues.stDisch = energyUsage.powers.storageDischarge.sumData.monthlyEnergyWh;
                }
                break;
            case 'yearly':
                {
                    energyUsage.pValues.pv = energyUsage.powers.pv.sumData.yearlyEnergyWh;
                    energyUsage.pValues.load = energyUsage.powers.load.sumData.yearlyEnergyWh;
                    energyUsage.pValues.grid = energyUsage.powers.gridImport.sumData.yearlyEnergyWh;
                    energyUsage.pValues.stDisch = energyUsage.powers.storageDischarge.sumData.yearlyEnergyWh;
                }
                break;
            case 'total':
                {
                    energyUsage.pValues.pv = energyUsage.powers.pv.sumData.energyWh;
                    energyUsage.pValues.load = energyUsage.powers.load.sumData.energyWh;
                    energyUsage.pValues.grid = energyUsage.powers.gridImport.sumData.energyWh;
                    energyUsage.pValues.stDisch = energyUsage.powers.storageDischarge.sumData.energyWh;
                }
                break;
        }
...
//        energyUsageLoadChart.dataProvider[0].energy = energyUsage.pValues.grid;     //grid
      if ( energyUsage.pValues.grid === 0) {
        energyUsageLoadChart.dataProvider[0].energy = 0;     //grid
      }else{
