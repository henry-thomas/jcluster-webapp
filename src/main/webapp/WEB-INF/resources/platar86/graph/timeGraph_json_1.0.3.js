    ...
    addData: function (d) {
        ...
        for (let i in d) {
            ...
            for (let j = 0; j < d[i].length; j++) { 
                if (!tc.dataBuf[d[i][j][0]])
                    tc.dataBuf[d[i][j][0]] = {};
            
                tc.dataBuf[d[i][j][0]][d[i][j][1]] = {
                    date: d[i][j][0],
                    name: d[i][j][1],
                    type: i,
                    data: d[i][j][2]
                            ...
                            .map(function (e) {
                                let date = moment(d[i][j][0] + ' ' + e[0], 'YYYY-MM-DD HH:mm:ss')._d;
                                let o = {
                                    lastUpdate:date,
                                    date: date
                                };
                                ...
                                switch(i) {
                                    case 'power':
                                        ...
                                        o.energyWh = e[2];
                                        o.dailyEnergyWh = e[3];
                                        o.weeklyEnergyWh = e[4];
                                        o.monthlyEnergyWh = e[5];
                                        o.yearlyEnergyWh = e[6];
                                        break;
                                    case 'storage':
                                        o.capacityP = e[1];
                                        o.capacityAh = e[2];
