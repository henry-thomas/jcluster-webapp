...
//        }
    ...
    init: function () {
        ...
        slemAnim.powerCircles.ph1 = new CircleGuage('ph1PowerCircle');
        slemAnim.powerCircles.ph2 = new CircleGuage('ph2PowerCircle');
        slemAnim.powerCircles.ph3 = new CircleGuage('ph3PowerCircle');
        slemAnim.powerCircles.sum = new CircleGuage('sumPowerCircle');
