...
//        this.otherInfoContent.classList.add('actDataContainer');
    ...
    function _initGui() {
        ...
        this.dataFields.batCharge = {};
        this.dataFields.batDischarge = {};
        this.dataFields.pvPower = {};
        this.dataFields.load = {};
        this.dataFields.gridImportPower = {};
        this.dataFields.gridExportPower = {};
        ...
        this.dataFields.batCharge.ratedPowerW = hh.adf(generalInfo, "Rated Charge Power", "W", {sIPrefix: true});
        this.dataFields.batDischarge.ratedPowerW = hh.adf(generalInfo, "Rated Discharge Power", "W", {sIPrefix: true});
        ...
        hh.addHeaderTitleToPC(operationalInfo, "Power Values");
        this.dataFields.gridExportPower.powerW = hh.adf(operationalInfo, "Grid Export Power", "W", {decimal: 1, sIPrefix: ["k"]});
        this.dataFields.gridImportPower.powerW = hh.adf(operationalInfo, "Grid Import Power", "W", {decimal: 1, sIPrefix: ["k"]});
        this.dataFields.load.powerW = hh.adf(operationalInfo, "Load Power", "W", {decimal: 1, sIPrefix: ["k"]});
        this.dataFields.batCharge.powerW = hh.adf(operationalInfo, "Bat Charge Power", "W", {decimal: 1, sIPrefix: ["k"]});
        this.dataFields.batDischarge.powerW = hh.adf(operationalInfo, "Bat Discharge Power", "W", {decimal: 1, sIPrefix: ["k"]});

        hh.addHeaderTitleToPC(operationalInfo, "Running State");
        ...
        this.dataFields.batVoltageV = hh.adf(dcBatInfo, "Voltage", "V", {decimal: 1});
        ...
        this.dataFields.batPowerW = hh.adf(dcBatInfo, "Power", "W", {decimal: 1});
        this.dataFields.batCurrentA = hh.adf(dcBatInfo, "Current", "A", {decimal: 1});
...
//        new ParamSetting("The section to add to", 'Name of parameter', {type: 'inputNumber/switch/dropdown/dropDownButton', title: 'Display name', ctrlInfo: "Description"})
    ...
    function _initGuiParam() {
        ...
        this.params.onOff = new ParamSetting(operationalSettingsPanel, 'onOff', {type: 'inputNumber', title: 'Power', ctrlInfo: "ON / OFF"});
        ...
        this.params.chargingDirection = new ParamSetting(operationalSettingsPanel, 'chargingDirection', {type: 'inputNumber', title: 'chargingDirection', ctrlInfo: " "});
        this.params.pbd250Enabled = new ParamSetting(operationalSettingsPanel, 'pbd250Enabled', {type: 'inputNumber', title: 'pbd250Enabled', ctrlInfo: " "});
